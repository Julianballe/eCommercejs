...
header.innerHTML = `
    <div class="container">
        <div class="bg-body-tertiary">
            <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                <a href="/" class="col-3 d-flex align-items-center mb-2 mb-lg-0 link-body-emphasis text-decoration-none">
                    <img src="./assets/img/logonike.png" class="bi me-2" width="60" height="48" alt=""/>
                    <h1 class="header_title">NikeStore</h1>
                </a>
        ...
        <ul class="nav">
            <li class="nav-item">
            <a href="./pages/orders.html" class="nav-link link-dark px-2"><img src="./assets/img/facturar.png" alt=""></a>
            </li>
            <li class="nav-item">
            <a href="./pages/wishlist.html" class="nav-link link-dark px-2"><img src="./assets/img/corazon.png" alt=""></a>
            </li>
            <li class="nav-item">
            <a href="./pages/cart.html" class="nav-link link-dark px-2"><img src="./assets/img/carrito.png" alt=""></a>
            </li>
        </ul>
        </div>
        </nav>
