...
headerpage.innerHTML = `
    <div class="container">
        ...
        <ul class="nav">
            <li class="nav-item">
            <a href="./orders.html" class="nav-link link-dark px-2"><img src="../assets/img/facturar.png" alt=""></a>
            </li>
            <li class="nav-item">
            <a href="./wishlist.html" class="nav-link link-dark px-2"><img src="../assets/img/corazon.png" alt=""></a>
            </li>
            <li class="nav-item">
            <a href="./cart.html" class="nav-link link-dark px-2"><img src="../assets/img/carrito.png" alt=""></a>
            </li>
        </ul>
        </div>
        </nav>
